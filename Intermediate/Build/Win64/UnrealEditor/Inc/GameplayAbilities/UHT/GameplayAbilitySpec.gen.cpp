...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayAbilitySpec_Statics::NewProp_ActivationInfo = { "ActivationInfo", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayAbilitySpec, ActivationInfo), Z_Construct_UScriptStruct_FGameplayAbilityActivationInfo, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ActivationInfo_MetaData), NewProp_ActivationInfo_MetaData) }; // 3740424637
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Unreal_Projects_Test_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayAbilitySpec_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FGameplayAbilityActivationInfo::StaticStruct, Z_Construct_UScriptStruct_FGameplayAbilityActivationInfo_Statics::NewStructOps, TEXT("GameplayAbilityActivationInfo"), &Z_Registration_Info_UScriptStruct_GameplayAbilityActivationInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayAbilityActivationInfo), 3740424637U) },
		{ FGameplayAbilitySpec::StaticStruct, Z_Construct_UScriptStruct_FGameplayAbilitySpec_Statics::NewStructOps, TEXT("GameplayAbilitySpec"), &Z_Registration_Info_UScriptStruct_GameplayAbilitySpec, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayAbilitySpec), 836290669U) },
		{ FGameplayAbilitySpecContainer::StaticStruct, Z_Construct_UScriptStruct_FGameplayAbilitySpecContainer_Statics::NewStructOps, TEXT("GameplayAbilitySpecContainer"), &Z_Registration_Info_UScriptStruct_GameplayAbilitySpecContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayAbilitySpecContainer), 3795966270U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Test_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayAbilitySpec_h_2042190967(TEXT("/Script/GameplayAbilities"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_Test_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayAbilitySpec_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Test_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayAbilitySpec_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_Test_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayAbilitySpec_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Test_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayAbilitySpec_h_Statics::EnumInfo));
// End Registration
